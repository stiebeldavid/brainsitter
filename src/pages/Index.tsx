...
import { Download, Brain, Computer, Apple } from "lucide-react";
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full p-4 border rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent text-base"
                />
              </div>
            </div>
